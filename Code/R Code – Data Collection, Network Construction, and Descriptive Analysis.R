...
# Load modularity dataset derived from Gephi and join with Tweet dataset
Nordstream_modularity <- read.csv("~/Desktop/Nordstream_modularity_data.csv", stringsAsFactors = FALSE)
...
Nordstream_class_data <- rename(Nordstream_class_data, community_id = modularity_class) # Saved as "Nordstream_class_data.csv"
