...
<p align="justify">
Moreover, through the use of social network analysis, and topic modelling we have identified and labelled different communities in the retweet network, each of which had distinct topics of discussion. As displayed by the Kernel density graph (Figure 11), part of this difference was due to the moment in time in which the debate in the different communities took place – as people were tweeting around the specific events or topics of debate related to the peaks (Figure 10). Unsurprisingly, we also found that language affiliations increase interactions and pull communities closer together. 
 </p> 

<p align="justify">
Still, while taking these two considerations into account, our findings suggest that the further apart two communities were, the more their topics of discussion differed, and the more different their identities and ideologies seemed to be. In fact, while in the left side of the graph we see a discourse dominated by pro-kremlins and conspiracy theories which are quite close together (FIND TECHNICAL TER) – all of which suspect or directly blame the US to be behind the sabotage – the right hand side displays journalists and anti-kremlin communities. Moreover, conspiracy theories were prevalent in some areas of the graph which our analysis found to be somewhat ideologically homogeneous – thus confirming that the spread of false messages is indeed prevalent in this type of communities as Stein et al. 2023 suggest. 
Finally, we found two peaks concerning the accounts’ date of creation. although we were not able to track them to a specific event, it is still worth noting these accounts were created around one month after the invasion and one month after the Nord Stream sabotage. 
</p> 
